...
<head>
    ...
    <title>DriftOps Analysis Report</title>
    <style>
        :root {{
            --color-bg: #0f172a;
...
<body>
    <div class="container">
        <header>
            <h1>🔍 DriftOps Analysis Report</h1>
        ...
        <footer>
            <p>Generated by <a href="https://github.com/yourusername/driftops">DriftOps</a> — Terraform/OpenTofu module constraint analyzer</p>
        </footer>
    </div>
</body>
</html>"##,
